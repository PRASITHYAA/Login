...
<body>
    ...
    <div class="container">
        ...
        <!-- paragraph -->
        <p class="">Applicant understands that this is an Equal Opportunity Employer and is
        ...
        <div class="container">
            ...
            <form action="{{ route('disclaimer.store') }}" method="POST" enctype="multipart/form-data"
                class="row g-3">
                @csrf
                @if ($errors->any())
                ...
                <div class="col-md-4">
                    ...
                    <input style="background-color: rgba(248, 235, 235, 0.726);" type="date" class="form-control"
                        placeholder="Expected date to join" id="validationDefault01" name="Expectedatetojoin"
                        required>
                </div>
                <!-- Current Salary -->
                <div class="col-md-4">
                    <label for="validationDefault02" class="form-label">Current Salary <span
                            style="color: red;">*</span></label>
                    <input type="number" class="form-control" id="validationDefault02" name="CurrentSalary"
                        style="background-color: rgba(248, 235, 235, 0.726);" required>
                </div>
                <!-- Expected Salary -->
                <div class="col-md-4">
                    <label for="validationDefaultUpload" class="form-label">Expected Salary <span
                            style="color: red;">*</span></label>
                    <div class="input-group">
                        <input type="number" class="form-control" id="validationDefaultUsername"
                            name="ExpectedSalary" placeholder="Expected Salary" aria-describedby="inputGroupPrepend2"
                            required>
                    </div>
                </div>
                <!-- paragraph -->
                ...
                <div class="row ">
                    <!-- Signature -->
                    <div class="col-md-4">
                        <label for="validationDefault01" class="form-label">Signature <span
                                style="color: red;">*</span></label>
                        <input type="file" name="Signature" class="form-control" id="validationDefault01"
                            required>
                    </div>
                    <!-- <div class="col-md-4">
                    </div> -->
                    ...
                    <div class="col-md-4">
                        ...
                        <input style="background-color: rgba(248, 235, 235, 0.726);" class="form-control"
                            type="text" id="currentDate" value="01/08/2023" aria-label="Disabled input example"
                            name="date" readonly>
                    </div>
                    <!-- time -->
                    <div class="col-md-4 ">
                        ...
                        <input style="background-color: rgba(248, 235, 235, 0.726);" class="form-control"
                            type="text" id="currentTime" value="04.20 am" aria-label="Disabled input example"
                            name="time" readonly>
                    </div>
                    <div class="row g-3 pt-2">
                        <!-- Print Name -->
                        <div class="col-md-6">
                            <label for="validationCustom02" class="form-label">Print Name</label>
                            <input style="background-color: rgba(248, 235, 235, 0.726);" class="form-control"
                                type="text" value="Print Name" aria-label="Disabled input example"
                                name="printname" readonly>
                        </div>
                        <!-- PLACE -->
                        <div class="col-md-6">
                            <label for="validationDefault02" class="form-label">PLACE <span
                                    style="color: red;">*</span></label>
                            <input type="text" class="form-control" id="validationDefault02" name="place"
                                style="background-color: rgba(248, 235, 235, 0.726);" required>
                        </div>
                        <!-- checkbox -->
                    ...
                    <div style="display: flex;justify-content: end;  " class="groupfinal">
                        <a style="display: flex;align-items: center;" class="btn btn-secondary m-1 "
                            href="acheivement">Previous</a>
                        <a class="btn btn-primary m-1 ">Submit Form</a>

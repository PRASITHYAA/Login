...
<body>
    ...
    <!-- percentage -->
       <div class="container   mt-2">
        <div  class="progress-bar" role="progressbar" style="width: 90%; background-color: #111;color: white; " aria-valuenow="90" aria-valuemin="0"
            aria-valuemax="90%">90%</div>
        </div>
    <div class="container-fluid">
        <div class="container">
            @if ($errors->any())
        ...
        <form action="{{ route('acheivement.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <h2  class="text-center p-4">ACHEIVEMENTS, CO-CURRICULAR, EXTRA-CURRICULAR DETAILS</h2>
                ...
                <p class="border-bottom">List out your Acheivements here</p>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label red">*</label>
                    <input style="background-color: rgba(248, 235, 235, 0.726);" type="text" class="form-control" name="name" id="exampleFormControlInput1" placeholder="">
                </div>
                ...
                <div id="input-field" style="display: none;">
                    ...
                    <div class="mb-3">
                        ...
                        <input style="background-color: rgba(248, 235, 235, 0.726);" type="" class="form-control" name="Conference" id="exampleFormControlInput1"
                            placeholder="">
                    </div>
                </div>
                ...
                <p class=" " style="font-weight: bold;">Note: Accepted Formats For Image: jpg, jpeg, gif, png,
                    bmp
                    <br>
                    Size Limit: 50KB
                </p>
                ...
                <div id="input-field-2" style="display: none;">
                    ...
                    <input style="background-color: rgba(248, 235, 235, 0.726);" type="" class="form-control" id="exampleFormControlInput1" placeholder="">
                    <div class="col-md-3  p-2">
                        <label for="validationDefaultUpload" class="form-label">Upload All Your Project Documents
                            Here
                            <div class="input-group">
                                <input type="file" class="form-control" id="validationDefaultUsername"
                ...
                <div>
                    ...
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label"> Please use this section to
                            indicate
                        ...
                        <textarea style="background-color: rgba(248, 235, 235, 0.726);" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
                </div>
                <div class="col-md-3  mt-4 mb-5">
                    <label for="validationDefaultUpload" class="form-label">Upload All Your Project Documents Here
                ...
                <div>
                    ...
                    <div id="input-field-3" style="display: none;">
                        <div class="col-md-3  p-2">
                            <label for="validationDefaultUpload" class="form-label">Attach Your resume: In PDF Formt
                                <span class="red">*</span>
                            </label>
                            <div class="input-group">
                                <input type="file" class="form-control" id="validationDefaultUsername"
                ...
                <div>
                    ...
                    <div style="display: flex;justify-content:end;" class="pt-5">
                        <a  class="btn btn-secondary m-1" href="education">Previous</a>

...
<div class="container-fluid">
    <div class="container ">
        ...
        <form action="{{ route('career.education.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div>
                <label>
                    <input type="radio" name="radio_option" value="yes" onclick="showCheckboxes()" {{ $education=='yes'
                        ? 'checked' : '' }}> Yes
                </label>
                <label>
                    <input type="radio" name="radio_option" value="no" onclick="hideCheckboxes()" {{ $education=='no'
                        ? 'checked' : '' }}> No
                </label>
            </div>
            <div id="checkboxes" style="{{ $education == 'yes' ? '' : 'display: none;' }}">
                <!-- High School -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            ...
                            <input style="background-color: rgba(248, 235, 235, 0.726);" type="date"
                                ...
                                value="{{ old('high_school_to_date') ?? ($card->high_school_to_date ?? '') }}" required>
                        </div>
                        ...
                        <div class="col-lg-2">
                            ...
                            <input style="background-color: rgba(248, 235, 235, 0.726);" type="text"
                                class="form-control" placeholder="Class" id="high_school_class" name="high_school_class"
                        ...
                        <div class="col-lg-2">
                            ...
                            <select class="form-select" id="high_school_stream" name="high_school_stream" required>
                                <option selected disabled value="">Choose...</option>
                                <option value="CBSE" {{ old('high_school_stream')=='CBSE' || ($card->high_school_stream
                                    ?? '') == 'CBSE' ? 'selected' : '' }}>CBSE</option>
                                <option value="ICSE" {{ old('high_school_stream')=='ICSE' || ($card->high_school_stream
                                    ?? '') == 'ICSE' ? 'selected' : '' }}>ICSE</option>
                                <option value="IB" {{ old('high_school_stream')=='IB' || ($card->high_school_stream ??
                                    '') == 'IB' ? 'selected' : '' }}>IB</option>
                                <option value="IGCSE" {{ old('high_school_stream')=='IGCSE' || ($card->
                                    high_school_stream ?? '') == 'IGCSE' ? 'selected' : '' }}>IGCSE</option>
                                <option value="STATE BOARD" {{ old('high_school_stream')=='STATE BOARD' || ($card->
                                    high_school_stream ?? '') == 'STATE BOARD' ? 'selected' : '' }}>STATE BOARD</option>
                            </select>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <label class="form-label">Year of Passing
                                <span style="color: red;">*</span></label>
                            <input style="background-color: rgba(248, 235, 235, 0.726);" type="date"
                                class="form-control" placeholder="Year of Passing" id="higher_secondary_year_of_passing"
                                name="higher_secondary_year_of_passing">
                        </div>
                ...
                <div id="form3" style="display: none;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <label class="form-label">Address <span style="color: red;">*</span></label>
                            <input style="background-color: rgba(248, 235, 235, 0.726);" type="text"
                                class="form-control" placeholder="Address" id="diploma_address" name="diploma_address">
                        </div>
                        <!-- Diploma From Date -->
                        <div class="col-lg-2">
                            <label class="form-label">From (Date)
                ...
                <div id="form4" style="display: none;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <label class="form-label">Town/City <span style="color: red;">*</span></label>
                            <input style="background-color: rgba(248, 235, 235, 0.726);" type="text"
                                class="form-control" placeholder="Town/City" id="bachelors_city" name="bachelors_city">
                        </div>
                        <!-- Bachelors address -->
                        <div class="col-lg-2">
                            <label class="form-label">Address <span style="color: red;">*</span></label>
                        ...
                        <!-- Bachelors Course -->
                        <div class="col-lg-2">
                            <label for="" class="form-label">Course <span style="color: red;">*</span></label>
                ...
                <div id="form5" style="display: none;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <label class="form-label">Town/City <span style="color: red;">*</span></label>
                            <input style="background-color: rgba(248, 235, 235, 0.726);" type="text" id="master_city"
                                name="master_city" class="form-control" placeholder="Town/City">
                        </div>
                        <!-- address -->
                        <div class="col-lg-2">
                            <label class="form-label">Address <span style="color: red;">*</span></label>
                        ...
                        <div class="col-lg-2">
                            <label class="form-label">To (Date)
                                <span style="color: red;">*</span></label>
                            <input style="background-color: rgba(248, 235, 235, 0.726);" type="date" id="master_to_date"
                                name="master_to_date" class="form-control" placeholder="To (Date)">
                        </div>
                        <!-- years of passing -->
                        <div class="col-lg-2">
                            <label class="form-label">Year of Passing
                        ...
                        <div class="col-lg-2">
                            <label class="form-label">Class <span style="color: red;">*</span></label>
                            <input style="background-color: rgba(248, 235, 235, 0.726);" type="text" id="master_class"
                                name="master_class" class="form-control" placeholder="Class">
                        </div>
                ...
                <div id="form6" style="display: none;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <label class="form-label">Town/City <span style="color: red;">*</span></label>
                            <input style="background-color: rgba(248, 235, 235, 0.726);" type="text" id="doctorate_city"
                                name="doctorate_city" class="form-control" placeholder="Town/City">
                        </div>
                        <!-- doctorateaddress -->
                        <div class="col-lg-2">
                            <label class="form-label">Address <span style="color: red;">*</span></label>
                        ...
                        <div class="col-lg-2">
                            <label class="form-label">Filed of Interest <span style="color: red;">*</span></label>
                            <input style="background-color: rgba(248, 235, 235, 0.726);" type="text"
                                class="form-control" name="doctorate_filed_of_interest" id="doctorate_filed_of_interest"
                                placeholder="Filed of Interest">
                        </div>
                        <div class="col-lg-2">
            ...
            <div style="display: flex;justify-content: end; align-items: center;" class="mt-5">
                ...
                <a style="display: flex;align-items: center;" class="btn btn-secondary m-1 " href="card">Previous</a>

                            ...
                            <select class="form-select bg" name="sector_id" id="sector_id" required>
                                ...
                                @foreach ($sectors as $sector)
                                    <option value="{{ $sector->id }}"
                                        {{ old('sector') == $sector->id || request()->sector_id == $sector->id || (isset($jobApplication) && $jobApplication->sector_id == $sector->id) ? 'selected' : '' }}>
                                        {{ $sector->name }}</option>
                                @endforeach
                            </select>
                        </div>
                            ...
                            <select class="form-select bg" name="position_id" id="position_id" required>
                                ...
                                @foreach ($positions as $position)
                                    <option value="{{ $position->id }}"
                                        {{ old('position') == $position->id || request()->position_id == $position->id || (isset($jobApplication) && $jobApplication->position_id == $position->id) ? 'selected' : '' }}>
                                        {{ $position->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="fb_link" class="form-control bg"
                                placeholder="FB Profile Link" id="fb_link"
                                value="{{ old('fb_link') ?? ($jobApplication->fb_link ?? '') }}" required>
                        </div>
                        <!-- instalink -->
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control bg" placeholder="Instagram Profile Link"
                                ...
                                value="{{ old('instagram_link') ?? ($jobApplication->instagram_link ?? '') }}"
                                required>
                        </div>
                        <!-- linked link -->
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <label>Does Your Permanent Address is Different
                                ...
                                <input type="radio" name="permanent_address_input" value="yes"
                                    {{ old('permanent_address_input') == 'yes' || (isset($jobApplication) && $jobApplication->permanent_address_input == 'yes') ? 'checked' : '' }}
                                    id="yesRadio1">
                                Yes
                            </label> <br>
                            <label>
                                <input type="radio" name="permanent_address_input" value="no"
                                    {{ old('permanent_address_input') == 'no' || (isset($jobApplication) && $jobApplication->permanent_address_input == 'no') ? 'checked' : '' }}
                                    id="noRadio1">
                                No
                            </label>
                        </div>
                        ...
                        <div class="col">
                            ...
                            <div id="marriedInputs"
                                ...
                                <div class="row g-3">
                                    <div class="col-md-3">
                                        <!-- spousename -->
                                        <label class="form-label pt-2">Spouse Name <span
                                                class="red">*</span></label>
                                    ...
                                    <div class="col-md-3">
                                        <label for="spouse_phone" class="form-label pt-2">Phone/Mobile <span
                                                class="red">*</span></label>
                                        <input type="tel"
                                            class="form-control phoneInputField marital-status-input"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            <input type="file" class="form-control marital-status-input"
                                                name="spouse_image" accept="image/*" id="spouse_image"
                                                placeholder="">
                                        </div>
                                        <div class="form-group">

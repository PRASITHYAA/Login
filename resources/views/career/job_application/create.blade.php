...
<div>
    ...
    <div class="container-fuild">
        <div class="container">
            ...
            @endif
            {{-- {{ print_r(old()) }} --}}
            <form action="{{ isset($jobApplication) ? route('career.job_application.update', $jobApplication->id) : route('career.job_application.store') }}" method="POST"
                  enctype="multipart/form-data">
                @csrf
                @if(isset($jobApplication)) @method('PUT') @endif
                        ...
                        <select class="form-select bg" name="sector_id" id="sector_id" required>
                            ...
                            @foreach ($sectors as $sector)
                                <option value="{{ $sector->id }}"
                                    {{ (old('sector') == $sector->id || request()->sector_id == $sector->id || (isset($jobApplication) && $jobApplication->sector_id == $sector->id)) ? 'selected' : '' }}>{{ $sector->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <!-- Position -->
                        ...
                        <select class="form-select bg" name="position_id" id="position_id" required>
                            ...
                            @foreach ($positions as $position)
                                <option value="{{ $position->id }}"
                                    {{ (old('position') == $position->id || request()->position_id == $position->id || (isset($jobApplication) && $jobApplication->position_id == $position->id)) ? 'selected' : '' }}>{{ $position->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control bg" name="first_name" placeholder="First Name"
                               id="first_name" value="{{ old('first_name') ?? $jobApplication->first_name ?? '' }}" required>
                    </div>
                    <!-- lastname -->
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control bg " type="text" id="ageOutput" value="{{ old('age') ?? $jobApplication->age ?? '' }}"
                               name="age" readonly>
                    </div>
                    <!-- space -->
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="address" class="form-control bg" placeholder="Address"
                               name="address" id="address" value="{{ old('address') ?? $jobApplication->address ?? '' }}" required>
                    </div>
                    <!-- postal code -->
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control bg" placeholder="postal code" id="postal_code"
                               value="{{ old('postal_code') ?? $jobApplication->postal_code ?? '' }}" name="postal_code" required>
                    </div>
                    <!-- phone -->
                    <div class="col-md-4">
                        <label class="form-label">Phone/Mobile <span class="red">*</span></label><br>
                        <input type="tel" class="phoneInputField" name="phone" id="phone"
                    ...
                    <div class="col-md-4">
                        ...
                        <br>
                        <input type="tel" class="phoneInputField" name="alternative_phone" id="alternative_phone"
                               value="{{ old('alternative_phone') ?? $jobApplication->alternative_phone ?? '' }}" required>
                        <p class="errorText" style="color: red;"></p>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control bg" placeholder="Instagram Profile Link"
                               name="instagram_link" id="instagram_link" value="{{ old('instagram_link') ?? $jobApplication->instagram_link ?? '' }}"
                               required>
                    </div>
                    <!-- linked link -->
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control bg" placeholder="LinkedIn Profile Link"
                               name="linked_link" id="linked_link" value="{{ old('linked_link') ?? $jobApplication->linked_link ?? '' }}" required>
                    </div>
                    ...
                    <div class="col-md-4">
                        <label>Does Your Permanent Address is Different
                            ...
                            <input type="radio" name="permanent_address_input" value="yes"
                                   {{ old('permanent_address_input') == 'yes' || (isset($jobApplication) && $jobApplication->permanent_address_input == 'yes') ? 'checked' : '' }} id="yesRadio1">
                            Yes
                        </label> <br>
                        <label>
                            <input type="radio" name="permanent_address_input" value="no"
                                   {{ old('permanent_address_input') == 'no' || (isset($jobApplication) && $jobApplication->permanent_address_input == 'no') ? 'checked' : '' }} id="noRadio1">
                            No
                        </label>

                        <div id="formContainer1" class="{{ old('permanent_address_input') == 'no' || (isset($jobApplication) && $jobApplication->permanent_address_input == 'no')? 'hidden' : '' }}">
                            {{-- country --}}
                            ...
                            <input type="text" name="permanent_city" class="form-control bg permanent-address-input"
                                   id="permanent_city" value="{{ old('permanent_city') ?? $jobApplication->permanent_city ?? '' }}" placeholder="City">
                            ...
                            <input type="text" class="form-control bg permanent-address-input"
                                   ...
                                   value="{{ old('permanent_address') ?? $jobApplication->permanent_address ?? '' }}" placeholder="Address">
                            ...
                            <input type="number" class="form-control bg permanent-address-input"
                                   ...
                                   value="{{ old('permanent_postal_code') ?? $jobApplication->permanent_postal_code ?? '' }}" placeholder="Postal Code">
                            ...
                            <input type="tel" class="phoneInputField permanent-address-input" name="permanent_phone"
                                   id="permanent_phone" value="{{ old('permanent_phone') ?? $jobApplication->permanent_phone ?? '' }}">
                            <p class="errorText" style="color: red;"></p>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <input type="text" name="father_name" class="form-control bg" id="father_name"
                                   value="{{ old('father_name') ?? $jobApplication->father_name ?? '' }}" placeholder="Father's Name" required>
                        </div>
                    </div>
                    <!-- fatherdateofbirth -->
                    <div class="col-md-3">
                        ...
                        <input type="date" class="form-control" id="father_date_of_birth"
                               value="{{ old('father_date_of_birth') ?? $jobApplication->father_date_of_birth ?? '' }}" name="father_date_of_birth" required>
                    </div>
                    <!-- fatherphone -->
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control bg" id="mother_name"
                                   value="{{ old('mother_name') ?? $jobApplication->mother_name ?? '' }}" placeholder="mother's name" name="mother_name"
                                   required>
                        </div>
                    </div>
                    <!-- mother dob -->
                    <div class="col-md-3">
                        ...
                        <input type="date" class="form-control" name="mother_date_of_birth" id="mother_date_of_birth"
                               value="{{ old('mother_date_of_birth') ?? $jobApplication->mother_date_of_birth ?? '' }}" required>
                    </div>
                    <!-- motherphone -->
                    <div class="col-md-3">
                        <label class="form-label">Phone/Mobile <span class="red">*</span>
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="radio" name="marital_status" value="married"
                               {{ old('marital_status') == 'married' || (isset($jobApplication) && $jobApplication->marital_status == 'married') ? 'checked' : '' }} id="marital_status_yes"
                               onclick="showInputs()" required>
                        Married
                        <br>
                        <input type="radio" name="marital_status" value="single"
                               {{ old('marital_status') == 'single' || (isset($jobApplication) && $jobApplication->marital_status == 'single') ? 'checked' : '' }} id="marital_status_no"
                               onclick="hideInputs()" required>
                        Single

                        <div id="marriedInputs" class="{{ old('marital_status') == 'single' || (isset($jobApplication) && $jobApplication->marital_status == 'single') ? 'hidden' : '' }}">
                            <div class="col-md-12">
                                <!-- spousename -->
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control bg marital-status-input" id="spouse_name"
                                           value="{{ old('spouse_name') ?? $jobApplication->spouse_name ?? '' }}" name="spouse_name"
                                ...
                                <div class="input-group">
                                    <input type="date" class="form-control bg marital-status-input"
                                           ...
                                           value="{{ old('spouse_date_of_birth') ?? $jobApplication->spouse_date_of_birth ?? '' }}" placeholder="Date of Birth">
                                </div>
                                <!-- spouseemail -->
                                ...
                                <div class="input-group pb-2">
                                    <input type="email" class="form-control bg marital-status-input"
                                           name="spouse_email" id="spouse_email" value="{{ old('spouse_email') ?? $jobApplication->spouse_email ?? '' }}"
                    ...
                    <!-- single -->
                    <div id="singleInputs" class="{{ old('marital_status') == 'married' || (isset($jobApplication) && $jobApplication->marital_status == 'married') ? 'hidden' : '' }}">
                        <!-- Siblings -->
                        <div class="col-lg-6">
                            <p style="font-weight: bold;">Siblings :</p>
                            <label>
                                <input type="radio" name="siblings" value="yes" id="yesRadio2"
                                    {{ old('siblings') == 'yes' || (isset($jobApplication) && $jobApplication->siblings == 'yes')? 'checked' : '' }}> Yes
                            </label> <br>
                            <label>
                                <input type="radio" name="siblings" value="no" id="noRadio2"
                                    {{ old('siblings') == 'no' || (isset($jobApplication) && $jobApplication->siblings == 'no')? 'checked' : '' }}> No
                            </label>
                            <div id="formContainer2" class="{{ old('siblings') == 'no' || (isset($jobApplication) && $jobApplication->siblings == 'no')? 'hidden' : '' }}">
                                ...
                                <div class="input-group ">
                                    <input type="text" class="form-control bg sibling-name-input" id="siblings_name"
                                           value="{{ old('siblings_name') ?? $jobApplication->siblings_name ?? '' }}" placeholder="Siblings Name"
                                           name="siblings_name">
                                </div>
                                ...
                                <input type="date" name="siblings_date_of_birth"
                                       ...
                                       value="{{ old('siblings_date_of_birth') ?? $jobApplication->siblings_date_of_birth ?? '' }}" placeholder="Date of Birth">
                                <!-- siblings  email -->
                                <div class="col-lg-12 ">
                                    <label class="form-label pt-2">Email <span class="red">*</span></label>
                                    ...
                                    <!--siblings  phone -->
                                    <label class="form-label pt-2">Phone/Mobile <span class="red">*</span></label><br>
                                    <div class="input-group ">
                    ...
                    <div class="container ">
                        <div style="display: flex;justify-content: end; align-items: center; " class="  ">
                            <!-- button  -->
                            <a style="font-weight: bold;" class="btn btn-secondary m-1" href="instruction">Previous</a>

    ...
    <div>
        ...
        <div class="container-fuild">
            <div class="container">
                ...
                @endif
                {{-- {{ print_r(old()) }} --}}
                <form action="{{ route('career.job_application.store') }}" method="POST"
...
{{--
                    ...
                    <input style="background-color: rgba(248, 235, 235, 0.726);" type="text" class="form-control" value=" {{ $sector->id }}"{{ $sector->name }}">
                    <input class="form-select " name="sector_id" id="sector_id"
                        @php
                            $sectors = \App\Models\Sector::all();
                        @endphp
                        @foreach ($sectors as $sector)
                            value="{{ $sector->id }}"
                            {{ $position->sector_id  }}>{{ $sector->name }}</option>
                        @endforeach
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input class="form-control " type="date" name="dob" id="dob"
                        value="{{ old('dob') ?? '' }}" oninput="calculateAge()" required>
                </div>
                <!-- age -->
                <div class="col-md-4">
                    <label for="ageOutput">Your age is</label><br>
                    <input class="form-control bg " type="text" id="ageOutput" value="{{ old('age') ?? '' }}"
                        name="age" readonly>
                </div>
                <!-- space -->
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="fb_link" class="form-control bg" placeholder="FB Profile Link"
                        id="fb_link" value="{{ old('fb_link') ?? '' }}" required>
                </div>
                <!-- instalink -->
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <label>Does Your Permanent Address is Different
                        ...
                        <input type="radio" name="permanent_address_input" value="yes"
                            {{ old('permanent_address_input') == 'yes' ? 'checked' : '' }} id="yesRadio1">
                        Yes
                    </label> <br>
                    <label>
                        <input type="radio" name="permanent_address_input" value="no"
                            {{ old('permanent_address_input') == 'no' ? 'checked' : '' }} id="noRadio1">
                        No
                    </label>
                    ...
                    <div id="formContainer1" class="{{ old('permanent_address_input') == 'no' ? 'hidden' : '' }}">
                        ...
                        <input type="text" class="form-control bg permanent-address-input"
                            ...
                            value="{{ old('permanent_address') ?? '' }}" placeholder="Address">
                ...
                <div class="col-md-3">
                    ...
                    <div class="input-group">
                        <input type="text" name="father_name" class="form-control bg" id="father_name"
                            value="{{ old('father_name') ?? '' }}" placeholder="Father's Name" required>
                    </div>
                </div>
                <!-- fatherdateofbirth -->
                <div class="col-md-3">
                    ...
                    <input type="date" class="form-control" id="father_date_of_birth"
                        value="{{ old('father_date_of_birth') ?? '' }}" name="father_date_of_birth" required>
                </div>
                <!-- fatherphone -->
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="date" class="form-control" name="mother_date_of_birth" id="mother_date_of_birth"
                        value="{{ old('mother_date_of_birth') ?? '' }}" required>
                </div>
                <!-- motherphone -->
                <div class="col-md-3">
                    <label class="form-label">Phone/Mobile <span class="red">*</span>
                ...
                <div class="col-lg-6">
                    ...
                    <input type="radio" name="marital_status" value="married"
                        {{ old('marital_status') == 'married' ? 'checked' : '' }} id="marital_status_yes"
                        onclick="showInputs()" required>
                    Married
                    <br>
                    <input type="radio" name="marital_status" value="single"
                        {{ old('marital_status') == 'single' ? 'checked' : '' }} id="marital_status_no"
                        onclick="hideInputs()" required>
                    Single
                    <div id="singleInputs" style="display: none;">
                    </div>

                    <div id="marriedInputs" class="{{ old('marital_status') == 'single' ? 'hidden' : '' }}" style="display: none;">
                        <div class="col-md-12">
                            <!-- spousename -->
                            ...
                            <div class="input-group">
                                <input type="date" class="form-control bg marital-status-input"
                                    ...
                                    value="{{ old('spouse_date_of_birth') ?? '' }}" placeholder="Date of Birth">
                            </div>
                            <!-- spouseemail -->
                            ...
                            <div class="input-group pb-2">
                                <input type="email" class="form-control bg marital-status-input"
                                    name="spouse_email" id="spouse_email" value="{{ old('spouse_email') ?? '' }}"
                            ...
                            <div class="input-group">
                                <input type="tel" class="phoneInputField marital-status-input"
                                    name="spouse_phone" id="spouse_phone" value="{{ old('spouse_phone') ?? '' }}">
                                <p class="errorText" style="color: red;"></p>
                            </div>
                            <!-- spouseupload -->
                    ...
                    <div class="col-lg-6">
                        ...
                        <label>
                            <input type="radio" name="siblings" value="yes" id="yesRadio2"
                                {{ old('siblings') == 'yes' ? 'checked' : '' }}> Yes
                        </label> <br>
                        <label>
                            <input type="radio" name="siblings" value="no" id="noRadio2"
                                {{ old('siblings') == 'no' ? 'checked' : '' }}> No
                        </label>
                        <div id="formContainer2" class="{{ old('siblings') == 'no' ? 'hidden' : '' }}">
                            ...
                            <div class="input-group ">
                                <input type="text" class="form-control bg sibling-name-input" id="siblings_name"
                                    value="{{ old('siblings_name') ?? '' }}" placeholder="Siblings Name"
                                    name="siblings_name">
                            </div>

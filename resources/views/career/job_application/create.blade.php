                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <div id="formContainer1" class="{{ (old('permanent_address_input') == 'no') ? 'hidden': '' }}">
                            ...
                            <input type="text" class="form-control bg permanent-address-input"
                                   ...
                                   id="permanent_postal_code" value="{{ old('permanent_postal_code') ?? '' }}"
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="radio" name="marital_status" value="single"
                               {{ (old('marital_status') == 'married') ? 'single': '' }} id="marital_status_no"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group pb-2">
                                    <input type="email" class="form-control bg marital-status-input" name="spouse_email"
                                           id="spouse_email" value="{{ old('spouse_email') ?? '' }}"
                        ...
                        <div class="col-lg-6">
                            ...
                            <label>
                                <input type="radio" name="siblings" value="yes"
                                       id="yesRadio2" {{ (old('siblings') == 'yes') ? 'checked': '' }}> Yes
                            </label> <br>
                            <label>
                                <input type="radio" name="siblings" value="no"
                                       id="noRadio2" {{ (old('siblings') == 'no') ? 'checked': '' }}> No
                            </label>
                            <div id="formContainer2" class="{{ (old('siblings') == 'no') ? 'hidden': '' }}">
                                ...
                                <input type="date" name="siblings_date_of_birth" class="form-control sibling-name-input"
                                       id="siblings_date_of_birth" value="{{ old('siblings_date_of_birth') ?? '' }}"
                                       placeholder="Date of Birth">
                                <!-- siblings  email -->
                                <div class="col-lg-12 ">
                                    <label class="form-label pt-2">Email <span class="red">*</span></label>

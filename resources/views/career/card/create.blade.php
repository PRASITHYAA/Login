                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="col mt-4">
                                ...
                                <input style="background-color: rgba(248, 235, 235, 0.726);" type="text"
                                    class="form-control" placeholder="Name as per IDs" name="aadhar_name" id="aadhar_name"
                                    required>
                            </div>
                            <!-- aadharidnumber -->
                            <div class="col mt-4">
                                ...
                                <input style="background-color: rgba(248, 235, 235, 0.726);" type="text"
                                    class="form-control" placeholder="Aadhar Number" name="aadhar_id_number" id="aadhaar"

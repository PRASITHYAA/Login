@php use App\Models\CourseTitle;use App\Models\Sector; @endphp
    <!DOCTYPE html>
<html lang="en">
...
<div class="container">
    @php $sectors = Sector::all() @endphp
    @foreach($sectors as $sector)
        <h1 class="p-4">{{ $sector->name }}</h1>
        @php $trainings = CourseTitle::where('sector_id', $sector->id)->get() @endphp
